...
if __name__ == '__main__':
    ...
    # python ./src/cvperception/zoo/MDAFN/conver_params.py -c configs/MDAFN/MDAFN_r18vd_6x_coco.yml -p MDAFN_r18vd_dec3_6x_coco.pdparams -o MDAFN_r18vd_dec3_6x_coco_new.pth
    # python ./src/cvperception/zoo/MDAFN/conver_params.py -c configs/MDAFN/MDAFN_r18vd_6x_coco.yml -p MDAFN_r18vd_5x_coco_objects365.pdparams -o MDAFN_r18vd_5x_coco_objects365_new.pth
    # python ./src/cvperception/zoo/MDAFN/conver_params.py -c configs/MDAFNv2/MDAFNv2_r50vd_120e_coco.yml -p MDAFN_r50vd_1x_objects365.pdparams -o MDAFNv2_r50vd_1x_objects365_new.pth -v 2
